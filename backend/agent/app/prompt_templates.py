...
Similar past incidents and their fixes:
{related_list}
...
4) Consider the fixes from similar past incidents when suggesting solutions.
5) Provide a confidence level: low, medium, or high.
